...
int main(int argc, char * argv[])
{
	...
	printf("Example: %s sz.config testfloat_8_8_128.dat 8 8 128\n", argv[0]);
	exit(0);
    }
    ...
    cost_end();
    printf("timecost=%f (Note the real compression time cost is supposed to be lower because the timecost shown here includes the time of Java-C wrapper data copying.)\n",totalCost); 
